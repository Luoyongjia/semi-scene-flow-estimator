...
__all__ = ['KITTI_unlabel']

class KITTI_unlabel(data.Dataset):
    """
    Load the selected processed unlabeled KITTI point clouds dataset.
    Args:
    ...
    def __init__(self, train, transform, num_points, data_root, remove_ground = True):
        self.root = os.path.join(data_root, 'raw_KITTI_Dataset_complex')
        self.train = train
